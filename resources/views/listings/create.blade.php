<x-layout>
  <x-card class="p-10 max-w-lg mx-auto mt-24">
    <header class="text-center">
      <h2 class="text-2xl font-bold uppercase mb-1">Add Book</h2>
      <p class="mb-4">Post a Book to find a buyer</p>
    </header>
    ...
    <form method="POST" action="/listings" enctype="multipart/form-data">
      ...
      <div class="mb-6">
        ...
        <input type="number" step="0.01" class="border border-gray-200 rounded p-2 w-full" name="location"/>
      ...
      <div class="mb-6">
        ...
        <textarea class="border border-gray-200 rounded p-2 w-full" name="description" rows="10"
         placeholder="Include synopsis, characters, etc">{{old('description')}}</textarea>
